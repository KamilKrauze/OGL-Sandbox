...
#define DEFINE_DELEGATE_NoParam(NAME, PAYLOAD_TYPENAME) DEFINE_PAYLOAD_NoParam(PAYLOAD_TYPENAME) \
...
#define DEFINE_DELEGATE_OneParam(NAME, PAYLOAD_TYPENAME, TYPE1, NAME1) DEFINE_PAYLOAD_OneParam(PAYLOAD_TYPENAME, TYPE1, NAME1) \
template<typename PayloadT> \
struct __##NAME \
{ \
private: \
