...
workspace "OGL-Sandbox"
    ...
    include "./ShadowMapping/premake5.lua"
    include "./TransmissionMapping/premake5.lua"
    include "./IndirectDrawing/premake5.lua"
    include "./InstancedIndirectDrawing/premake5.lua"